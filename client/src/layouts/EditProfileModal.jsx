                ...
                <div className="modal-box w-full bg-gray-900 rounded-lg shadow md:mt-0 sm:max-w-md xl:p-0">
                    ...
                    <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                        ...
                        <div className="space-y-4 md:space-y-6">
                            ...
                            <button onClick={onSubmit} id="submitButton" className="w-full text-white bg-gray-700 hover:bg-gray-800 py-2 rounded-md hover:bg-gray-900 transition-all ease-in-out">Update account</button>
